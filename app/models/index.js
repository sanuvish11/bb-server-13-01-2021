...
db.workarea = require("../models/workarea.model")(sequelize, Sequelize);
db.personalfav = require("../models/Personalfav.model")(sequelize, Sequelize);
db.journey = require("../models/Jounery.model")(sequelize, Sequelize);
